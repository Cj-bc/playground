...
var author$project$Main$Model = F4(
	function (entries, title_field, detail_field, uid) {
		return {detail_field: detail_field, entries: entries, title_field: title_field, uid: uid};
	});
...
var author$project$Entry$Entry = F4(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Mark as done')
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text('remove this')
					]))
			]));
};
